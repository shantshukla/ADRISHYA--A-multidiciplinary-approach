...
# this is used to capture viqdeo in OpenCV# fourCC is a 4-byte video code, used to specify the video code# for Windows, the video code is "'XVID'" and for Mac, it is "'MJPG'"out = cv2.VideoWriter('output.avi', fourCC, 20, (200, 200))# (fileName, fourCCvariable, framesPerSec, frameSize)
...
while(cap.isOpened()): # while your camera is opened, this will run
    ...
    lower_red = np.array([50, 100, 100]) # saturation is 120-255, value is 50-255

    upper_red = np.array([70, 255, 255]) # https://tinyurl.com/hsvColors
