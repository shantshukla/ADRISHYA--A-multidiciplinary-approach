...
while(cap.isOpened()): # while your camera is opened, this will run
    ...
    lower_blue = np.array([90, 103, 20]) # saturation is 120-255, value is 50-255

    upper_blue = np.array([119, 255, 255]) # https://tinyurl.com/hsvColors
