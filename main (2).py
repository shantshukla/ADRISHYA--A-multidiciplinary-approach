...
# this is used to capture video in OpenC

# fourCC is a 4-byte video code, used to specify the video code

# for Windows, theq video code is "'XVID'" and for Mac, it is "'MJPG'"
...
while(cap.isOpened()): # while your camera is opened, this will run
    ...
    cv2.imshow('Adrishya', finalOutput)


    # shown in fourCC video writer as 'Adrishya'
